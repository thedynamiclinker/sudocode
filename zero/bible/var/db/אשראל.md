What follows is a translation of a set of documents of unknown provenance, which translation immediately aborts for reasons that appear to be something like theological unease, after which the translation becomes a commentary on the original text that does not include the original text or a translation thereof, but merely aims to give the reader an idea of what was in the original, from the translator's (not entirely dispassionate) point of view.

The translation, its abortion, and its transformation to commentary follows below.
...
Can we do two title pages?

Am I gonna be that kind of author? 
...
"When the Highest (i.e., YHWH) 
gave nations their inheritance,
he set the boundaries according 
to the number of the children
of Israel. And YHWH's portion 
in that division was Israel."
-Deut 32, Society of Extremely 
...
(At this point, the translator appears to give up on direct translation and instead switch to a commentary on the original.)
