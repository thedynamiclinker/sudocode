...
NOTE: This used to enter into [[The Book of J]] because I was using it for something else outside the book, but I've decided that section sucks and needs to die in a big delete-y fire.

See /zero/Todo for current thoughts on where Sumerian Dog Joke section belongs and why.
