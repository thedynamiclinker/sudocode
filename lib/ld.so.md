...
## TODO
- [x] Move ld into here.
- [ ] Move the "first code ever" to /lib/art (arithmetic runtime.)
...
1: Hey wait, this file has the same name as the last one! Don't tell me we're only halfway done with this lecture. Wait why are we in `lib`? Is this a trick? Zero!
...
1: Well I was, because you kept listing computers and talking to yourself. But then we switched files so now I'm awake. Seems like something might finally happen.
...
_(Narrator: 1 quickly drags eyes back and forth across each line as if to make sure they're all in 1's brain's L1 cache at once.)_
...
0: And the moment it first hits us there's so much capital-T Truth we can't breathe. My god. It explodes all at once once we're down there and for months || years after it takes every moment of our daily foreground && background thought. Propositional. Predicate. Let L be a Language. Induction on the number of quantifiers and connectives. Nand is universal. Implementing And and Or. Tarski having the audacity to literally define Truth. It all felt right from first contact. But here the entire subject is still tame. In a few pages it starts escalating step after step and before long the tame rigor is an absolute acid trip. Now: Completeness Gödel Henkin. Syntax smuggled into Semantics as a hack. That's a model? That counts? Now Skolem-Löwenheim. Upward Downward. How the hell is THAT not a paradox? Hey mathematics? Is anyone there? Why aren't there more people down here with me at this wild-ass zoo? A real numbers object that's countable from outside but proves itself uncountable from inside and everyone's like _that's fine_? Absolutely melted. Mind rewritten. This is everything I need. Chapter next. Our first programming language. Aka the first-order theory of formal arithmetic. Aka PA. Those exercises. The ones that go on endlessly from (a) to like fucking (z prime) because they run out of letters and have to add primes. So many of them. So mindless. And that was where for the first time we saw how "mindless" could mean "beautiful." Could mean "precise," "automatable," "the first mathematics you've ever seen that's _actually well-defined_ and thus _requires no mind._" Mindless from then took on a new meaning, aside from "mindless" in the usual sense of "super fucking dumb." Right after those mindless exercises, everything changes yet again. Primitive recursive functions. I wonder why they're doing this. Mu operator. That's odd. "Partial" recursive functions? Never heard that word before. Why partial? Normal math upstairs just says stuff like "piecewise" or "everywhere defined on its domain" the latter of which of course means absolutely fucking nothing. And then it hits. Now look, it's sad in a way how every damn book on earth talks about Gödel and incompleteness. It's the only thing they seem capable of talking about in any popular book that halfway mentions downstairs. And the fact of how boring and predictable that choice is shouldn't be diminished because it's true, there's entirely too much of that. That's an entirely different issue from what it feels like when you hit it. A young mind, not knowing what's coming up a few pages ahead. Sure, you've heard of Gödel. Hell you read the first half of the textbook and it's not as if he never shows up in there. And you've heard all the popular descriptions of incompleteness so many times that the conclusion is already underwhelming at this point. That's not "it". The "it" that hits, right after they define primitive recursion and mu. Because what comes now, it looks different from anything else you've ever seen. And for a young or youngish mind that doesn't know what's coming, it's like feeling the act of "programming" being ripped into existence for the first time by a mind of the kind that had never been seen before on earth. It starts---

_(Narrator: At this point, 0's manic rant about \[topic-still-unclear\] has reached the point where I can no longer in good conscience allow it to continue. It's inconsiderate, considering 1's lack of background in formal logic (not to mention the Reader, who I'm sure is quite confused) and a responsible Narrator has no option but to move the remainder of 0's manic gibberish to the `/opt` directory, where optional things are sent, as a punishment for whatever sins have made them less essential than they otherwise might have been. Depart, ye cursed, into everlasting partial relevance. The remainder of \[whatever-0-is-on-about\] can be found in  [[mendelson|/opt/mendelson]])_
...
0: Ridiculous. I was perfectly coherent in there.

1: Oh. Well to be honest I didn't understand a lot of that. Plus it did seem a little manic in that long paragraph without any line breaks.
...
0: Yes the first code ever written. By any human on earth. Or at least the thing I'd cast my vote for among all the other things we might choose to call the first ever code. How did that get tossed in `/opt`?

1: I'm gonna go read it.

0: I'll come with you.

1: Ok I read it.

0: Me too. I mean I wrote it. But yeah.
