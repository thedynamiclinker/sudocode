...
_(Narrator: At this point, 0's mentally ill rant about \[topic-still-unclear\] has reached a level of manic incoherence where I can no longer in good conscience allow it to continue. It's inconsiderate, considering 1's lack of background in whatever topic this is (not to mention the Reader, who I'm sure is quite confused) and a responsible Narrator has no option but to move the remainder of 0's manic gibberish to the `/opt` directory, where optional things are sent, as a punishment for whatever sins have made them less essential than they otherwise might have been. Depart, ye cursed, into everlasting partial relevance. The remainder of \[whatever-0-is-on-about\] can be found in  [[opt/art|/opt/art]])_
