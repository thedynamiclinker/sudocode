...
- Jeff Hirst's advisors were:
	- Harvey Friedman (who we saw up above in The Sigmas) and
	- Stephen Simpson (the other founder of The Sigmas)
	- And The Sigmas are the culture of Reverse Mathematics.
	- And Reverse Mathematics is the same "All of mathematics is equivalent to one of five sentences" research program mentioned earlier.)
...
The document ends here, abruptly in the middle.
