#images-doctored #cites-logicomix 
...
0: Well it was, but at the time even this system seemed pretty great compared to the alternatives. Remember the only alternative back then was _Principia_ and even older stuff, and no one reads _Principia_.

![[principia-mathematica-05.png]]

1: No one reads _Principia_?

![[logicomix-01.png]]

0: **No one** reads _Principia._
...
## Reminiscences of Logicians: Pre Print

## Reminiscences of Logicians: Pre Print

(Editor's Note: At this point in the original source, there is a sequence of images showing the same conversation between Kleene et al. in physically printed media, that is a paper book. This appears to contradict Zero's claim above that he was working from an audio recording.)

![[reminiscences-of-logicians-opening-01.jpg]]

![[reminiscences-of-logicians-opening-02.jpg]]

![[reminiscences-of-logicians-opening-03.jpg]]

![[reminiscences-of-logicians-opening-04.jpg]]

![[reminiscences-of-logicians-opening-05.jpg]]

![[reminiscences-of-logicians-opening-06.jpg]]

(E.N. cont'd: Whatever the provenance of this document, it is hard to imagine that it was not compiled and assembled from multiple sources, before finally being linked together into its present form by an unknown individual or group commonly referred to as The Linker.)
...
0: Yeah, apparently one of the referees of that paper was like "Hey Church? You cited Kleene like eight thousand times in there man. It seems like this is all his results."

Church even writes Kleene a letter about it later.

![[church-kleene-correspondence-01.jpg]]

1: "in connection with your thesis"? Is Church attributing Church's Thesis to Kleene there when he calls it "your thesis"?

0: I don't think so. I think he means Kleene's PhD thesis there. The other "your thesis."

1: Damn Alonzo Church, so many names for the same thing.

0: So many things for the same name.\*

1: Right yeah ok.

0: But I was unfair to Church earlier. When Kleene said "I have to give the credit to Church, I can't take it myself," he wasn't talking about all the programming, he was talking about Church's Thesis.
...
![[church-kleene-correspondence-02.jpg]]
...
0: That's it. Remember they started with Church's larger system: a new foundation for logic.


![[church-kleene-correspondence-03.jpg]]

0: They explored this system for a while, found something they called "the perpetual motion function," more on that later.

![[church-kleene-correspondence-04.jpg]]

0: Then a contradiction was found in that system.

![[church-kleene-correspondence-05-v1.jpg]]

0: And lambda-definability was extracted from that inconsistent system.

![[church-kleene-correspondence-05-v2.jpg]]

0: But Church attributes the notion of lambda-definability to Kleene and himself.

1: You still didn't explain what "we're done" means. What's "effectively calculable" exactly? You have an intuitive description but not an exact one.

0: The "exact" description of that term is an _intuitive_ description.

1: Excuse me?

0: Here listen.

![[church-kleene-correspondence-06.jpg]]

0: There's some foreshadowing at the end about Gödel.

1: Foreshadowing of what?

0: No spoilers.

1: Spoilers of what?

0: No recursion. At least not yet. We'll get there soon.

![[church-kleene-correspondence-07.jpg]]

1: So what's Church's Theorem exactly? You just described it as "we're done."

0: They call it a thesis, not a theorem. Church's Thesis is that "whatever we mean by 'computable' in an intuitive informal sense, lambda-definability captures that intuitive idea in a precise formal sense."

1: Why "thesis" and not "theorem"?

0: Because it's saying "I think this informal concept equals this formal concept." Can't exactly prove that in the usual mathematical sense. It's pre-mathematics. The hypothesis is that lambda definability captures what we intuitively mean by "computable." Way more powerful than just a theorem. In other words, Church's Theorem is the scientific (and in some sense empirical) hypothesis that He and Kleene "got" all of computation captured in the net of this definition.

1: What on earth made him think "We got ALL computation"?
