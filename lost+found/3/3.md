...
(Editor's Note: At this point in the original source, there is a sequence of images showing the same conversation between Kleene et al. in physically printed media, that is a paper book. This appears to contradict Zero's claim above that he was working from an audio recording. Whatever the provenance of this document, it is clear that it was compiled from multiple sources, before finally being linked together by an unknown individual or group who I suppose one might call The Linker.)
