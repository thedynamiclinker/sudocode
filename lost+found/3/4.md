...
0: I mean, you have a free variable, and then you plugged it into another free variable. They're both functions. Cuz everything's functions. But neither of them has any lambdas in it. So it's syntactically ok, but we can't reduce it any further. It just sort of sits there. Which I guess is why I'm just sitting here. I'm your repl.
