...
![[logos-john-1-1.png]]
![[zero/include/the-lambdas-big/logos-to-logic.jpg|300]]

1: NO.

0: Ok ok I know. Just teasing ya a bit.

1: Don't.

0: On a more serious now, the history of logic starts...
...
![[history-of-logic-notation-03-2.png]]
...
0: Ok so Leibniz was an absolute badass. Invented calculus, but thought most math was kinda "meh." But he desperately wanted to build a universal system for reasoning and computing. Dude was literally the most "Foundational" a Foundational person could possibly be.
...
0: He also invented binary. But we're getting ahead of ourselves. Here's him saying "Most math is meh, let's formalize thought, that's way more important than your lame puzzles guys seriously." Take it away Leibniz.
