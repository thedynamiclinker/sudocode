...
0: Off to a good start! Here, I'll draw a picture to explain.
...
![[trinity-2-el-al-al-bg-transparent.png]]
...
![[trinity-6-lambda-and-mu-bg-transparent.png]]
...
![[trinity-7-unhinged-bg-transparent.png]]
...
_(Narrator: 0, not listening to Narrator, continues working.)_
 ...
 0: _(Typing into a shell)_ So much. Too much to. More. The principles. So much more.
...
0: _(Mumbling to 0self)_ Just a bit. In a bit. We still... The lambdas. The mus. Need the other ones. The letters. We need the etc. The groups. So much mo...
