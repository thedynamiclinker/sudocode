...
This directory contains some files from Julian Assange's `rubberhose` deniable encryption system.

Some time around 20XY, the only available copy was removed from github.

So one of the Authors of this book tossed it up on github (he apparently had it on an external hard drive, fortunately).

He now appears to be the primary archivist of this very important thing in the history of our era of computing, modulo the high-ish likelihood that it's also hosted in lots of other places we didn't check, because the internet is big.

---

TABLE OF CONTENTS
- [[MYTHOLOGY]] (read this one)
- [[ENUMAELISH]] (this is literally the Enuma Elish)
- [[REMEMBERME]] (that's this file, for the record)
