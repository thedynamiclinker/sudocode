...
uname output: Sudocode 1.0.0-aleph-0 λογ-OS ϺΜΠ PREEMPT_DYNAMIC ευ-Fri 08:21 ευTC 20XY Bk GNU/Linux
...
Description:
	...
	1. echo "$(case a in a) echo 'hi!';; esac)"  
	2. echo "$(case a in b) echo 'hi!';; esac)"  
...
_(Narrator: After some conversation, 0 & 1 send the patch.)_

## mail

```
~ $ git send-email --to "bug-bash@gnu.org" ./0001-a-bug-in-history.patch

From: 1 <user@thedynamiclinker.com>
To: bug-bash@gnu.org
Cc: 0 <root@thedynamiclinker.com>
Subject: [PATCH] Fix interaction between shell history and case-in-comsub
Date: Fri,  2 Jan 2026 16:23:01 -0600
Message-ID: <20260102222301.171134-1-root@thedynamiclinker.com>
...
[Insert email here, and Chet's response.]
```
